...
<body >
	...
	<div>
		<a class="btn btn-danger pull-right" ng-click="clearCart()"> <span class="glyphicon glyphicon-remove-sign">
		</span> Clear Cart
		</a>
		<c:url value="/order/${cartId}" var="url"></c:url>
		<a href="${url }" class="btn btn-danger pull-left">Order</a>
	...
	<c:url value="/productsListAngular" var="url"></c:url>
		<a href="${url }" class="btn btn-danger pull-right">Continue shopping</a>
